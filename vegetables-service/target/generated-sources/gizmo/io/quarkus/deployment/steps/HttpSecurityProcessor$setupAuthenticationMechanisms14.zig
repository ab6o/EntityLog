// Class: io/quarkus/deployment/steps/HttpSecurityProcessor$setupAuthenticationMechanisms14
...
(
    ...
    ** label1
    ...
    INVOKEVIRTUAL io/quarkus/deployment/steps/HttpSecurityProcessor$setupAuthenticationMechanisms14#deploy_0
    RETURN
    ** label2
...
(
    ...
    ** label1
    ...
    ASTORE 5
    ALOAD 5
    CHECKCAST io/quarkus/vertx/http/runtime/security/HttpSecurityRecorder
