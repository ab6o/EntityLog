// Class: io/quarkus/deployment/steps/VertxCoreProcessor$eventLoopCount11
...
(
    ...
    ** label1
    ...
    INVOKEVIRTUAL io/quarkus/deployment/steps/VertxCoreProcessor$eventLoopCount11#deploy_0
    RETURN
    ** label2
