// Class: io/quarkus/deployment/steps/VertxCoreProcessor$eventLoopCount13
...
(
    ...
    ** label1
    ...
    INVOKEVIRTUAL io/quarkus/deployment/steps/VertxCoreProcessor$eventLoopCount13#deploy_0
    RETURN
    ** label2
