// Class: io/quarkus/deployment/steps/BlockingOperationControlBuildStep$blockingOP16
...
(
    ...
    ** label1
    ...
    INVOKEVIRTUAL io/quarkus/deployment/steps/BlockingOperationControlBuildStep$blockingOP16#deploy_0
    RETURN
    ** label2
