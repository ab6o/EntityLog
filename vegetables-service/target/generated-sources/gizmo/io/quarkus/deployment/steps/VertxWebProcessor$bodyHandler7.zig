// Class: io/quarkus/deployment/steps/VertxWebProcessor$bodyHandler7
...
(
    ...
    ** label1
    ...
    INVOKEVIRTUAL io/quarkus/deployment/steps/VertxWebProcessor$bodyHandler7#deploy_0
    RETURN
    ** label2
...
(
    ...
    ** label1
    ...
    ALOAD 3
    AASTORE
    NEW io/quarkus/vertx/web/runtime/VertxWebRecorder
    DUP
    // Method descriptor: ()V
    INVOKESPECIAL io/quarkus/vertx/web/runtime/VertxWebRecorder#<init>
    ASTORE 4
    ALOAD 2
    LDC (Integer) 0
    ALOAD 4
    ...
    LDC (Integer) 0
    AALOAD
    CHECKCAST io/quarkus/vertx/web/runtime/VertxWebRecorder
    ALOAD 5
