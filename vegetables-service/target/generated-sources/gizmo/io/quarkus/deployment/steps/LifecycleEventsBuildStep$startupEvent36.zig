// Class: io/quarkus/deployment/steps/LifecycleEventsBuildStep$startupEvent36
...
(
    ...
    ** label1
    ...
    INVOKEVIRTUAL io/quarkus/deployment/steps/LifecycleEventsBuildStep$startupEvent36#deploy_0
    RETURN
    ** label2
