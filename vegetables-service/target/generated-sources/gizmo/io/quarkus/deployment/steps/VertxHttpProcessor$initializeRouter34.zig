// Class: io/quarkus/deployment/steps/VertxHttpProcessor$initializeRouter34
...
(
    ...
    ** label1
    ...
    INVOKEVIRTUAL io/quarkus/deployment/steps/VertxHttpProcessor$initializeRouter34#deploy_0
    RETURN
    ** label2
