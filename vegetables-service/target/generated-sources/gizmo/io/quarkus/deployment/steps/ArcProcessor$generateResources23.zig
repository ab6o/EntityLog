// Class: io/quarkus/deployment/steps/ArcProcessor$generateResources23
...
(
    ...
    ** label1
    ...
    INVOKEVIRTUAL io/quarkus/deployment/steps/ArcProcessor$generateResources23#deploy_0
    RETURN
    ** label2
...
(
    ...
    ** label1
    ...
    ALOAD 14
    CHECKCAST java/util/Collection
    LDC (String) "javax.json.JsonValue"
    // Method descriptor: (Ljava/lang/Object;)Z
    INVOKEINTERFACE java/util/Collection#add
    POP
    ALOAD 14
    CHECKCAST java/util/Collection
    LDC (String) "javax.json.JsonStructure"
    // Method descriptor: (Ljava/lang/Object;)Z
    INVOKEINTERFACE java/util/Collection#add
    POP
    ALOAD 14
    CHECKCAST java/util/Collection
    LDC (String) "javax.json.JsonNumber"
    // Method descriptor: (Ljava/lang/Object;)Z
    INVOKEINTERFACE java/util/Collection#add
    POP
    ALOAD 14
    ...
    ALOAD 14
    CHECKCAST java/util/Collection
    LDC (String) "io.quarkus.jackson.ObjectMapperProducer"
    // Method descriptor: (Ljava/lang/Object;)Z
    INVOKEINTERFACE java/util/Collection#add
    POP
    ALOAD 14
    ...
    ALOAD 14
    CHECKCAST java/util/Collection
    LDC (String) "javax.json.JsonObject"
    // Method descriptor: (Ljava/lang/Object;)Z
    INVOKEINTERFACE java/util/Collection#add
    POP
    ALOAD 14
    ...
    ALOAD 14
    CHECKCAST java/util/Collection
    LDC (String) "javax.json.JsonArray"
    // Method descriptor: (Ljava/lang/Object;)Z
    INVOKEINTERFACE java/util/Collection#add
    POP
    ALOAD 14
    ...
    ALOAD 14
    CHECKCAST java/util/Collection
    LDC (String) "javax.json.JsonString"
    // Method descriptor: (Ljava/lang/Object;)Z
    INVOKEINTERFACE java/util/Collection#add
    POP
    ALOAD 14
