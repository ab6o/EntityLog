// Class: io/quarkus/deployment/steps/ResteasyCommonProcessor$setupResteasyInjection27
...
(
    ...
    ** label1
    ...
    INVOKEVIRTUAL io/quarkus/deployment/steps/ResteasyCommonProcessor$setupResteasyInjection27#deploy_0
    RETURN
    ** label2
