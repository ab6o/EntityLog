// Class: io/quarkus/deployment/steps/NarayanaJtaProcessor$build6
...
(
    ...
    ** label1
    ...
    LDC (String) "/Users/anandhi/Work/EntityLog"
    // Method descriptor: (Ljava/lang/Object;Ljava/lang/Object;)Ljava/lang/Object;
    INVOKEINTERFACE java/util/Map#put
    POP
    ALOAD 4
...
(
    ...
    ** label1
    ...
    INVOKEVIRTUAL io/quarkus/deployment/steps/NarayanaJtaProcessor$build6#deploy_0
    RETURN
    ** label2
