// Class: io/quarkus/deployment/steps/VertxCoreProcessor$ioThreadDetector3
...
(
    ...
    ** label1
    ...
    INVOKEVIRTUAL io/quarkus/deployment/steps/VertxCoreProcessor$ioThreadDetector3#deploy_0
    RETURN
    ** label2
