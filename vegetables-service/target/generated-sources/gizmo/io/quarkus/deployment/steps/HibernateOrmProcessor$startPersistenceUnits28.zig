// Class: io/quarkus/deployment/steps/HibernateOrmProcessor$startPersistenceUnits28
...
(
    ...
    ** label1
    ...
    INVOKEVIRTUAL io/quarkus/deployment/steps/HibernateOrmProcessor$startPersistenceUnits28#deploy_0
    RETURN
    ** label2
