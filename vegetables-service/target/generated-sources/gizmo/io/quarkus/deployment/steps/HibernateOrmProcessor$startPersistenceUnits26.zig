// Class: io/quarkus/deployment/steps/HibernateOrmProcessor$startPersistenceUnits26
...
(
    ...
    ** label1
    ...
    INVOKEVIRTUAL io/quarkus/deployment/steps/HibernateOrmProcessor$startPersistenceUnits26#deploy_0
    RETURN
    ** label2
