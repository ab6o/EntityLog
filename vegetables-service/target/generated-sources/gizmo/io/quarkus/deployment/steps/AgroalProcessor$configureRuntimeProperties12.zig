// Class: io/quarkus/deployment/steps/AgroalProcessor$configureRuntimeProperties12
...
(
    ...
    ** label1
    ...
    INVOKEVIRTUAL io/quarkus/deployment/steps/AgroalProcessor$configureRuntimeProperties12#deploy_0
    RETURN
    ** label2
