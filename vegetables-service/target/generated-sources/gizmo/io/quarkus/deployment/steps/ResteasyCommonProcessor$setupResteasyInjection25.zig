// Class: io/quarkus/deployment/steps/ResteasyCommonProcessor$setupResteasyInjection25
...
(
    ...
    ** label1
    ...
    INVOKEVIRTUAL io/quarkus/deployment/steps/ResteasyCommonProcessor$setupResteasyInjection25#deploy_0
    RETURN
    ** label2
