// Class: io/quarkus/deployment/steps/UndertowBuildStep$servletContextBean15
...
(
    ...
    ** label1
    ...
    INVOKEVIRTUAL io/quarkus/deployment/steps/UndertowBuildStep$servletContextBean15#deploy_0
    RETURN
    ** label2
