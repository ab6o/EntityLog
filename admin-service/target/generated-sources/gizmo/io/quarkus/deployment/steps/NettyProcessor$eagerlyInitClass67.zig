// Class: io/quarkus/deployment/steps/NettyProcessor$eagerlyInitClass67
...
(
    ...
    ** label1
    ...
    INVOKEVIRTUAL io/quarkus/deployment/steps/NettyProcessor$eagerlyInitClass67#deploy_0
    RETURN
    ** label2
