// Class: io/quarkus/deployment/steps/VertxCoreProcessor$eventLoopCount67
...
(
    ...
    ** label1
    ...
    INVOKEVIRTUAL io/quarkus/deployment/steps/VertxCoreProcessor$eventLoopCount67#deploy_0
    RETURN
    ** label2
