// Class: io/quarkus/deployment/steps/BlockingOperationControlBuildStep$blockingOP74
...
(
    ...
    ** label1
    ...
    INVOKEVIRTUAL io/quarkus/deployment/steps/BlockingOperationControlBuildStep$blockingOP74#deploy_0
    RETURN
    ** label2
