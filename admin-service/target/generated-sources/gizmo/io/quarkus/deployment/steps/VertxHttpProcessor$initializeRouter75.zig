// Class: io/quarkus/deployment/steps/VertxHttpProcessor$initializeRouter75
...
(
    ...
    ** label1
    ...
    INVOKEVIRTUAL io/quarkus/deployment/steps/VertxHttpProcessor$initializeRouter75#deploy_0
    RETURN
    ** label2
