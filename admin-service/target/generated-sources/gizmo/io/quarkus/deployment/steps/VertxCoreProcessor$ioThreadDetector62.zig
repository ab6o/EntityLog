// Class: io/quarkus/deployment/steps/VertxCoreProcessor$ioThreadDetector62
...
(
    ...
    ** label1
    ...
    INVOKEVIRTUAL io/quarkus/deployment/steps/VertxCoreProcessor$ioThreadDetector62#deploy_0
    RETURN
    ** label2
