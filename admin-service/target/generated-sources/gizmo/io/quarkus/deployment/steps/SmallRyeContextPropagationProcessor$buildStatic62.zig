// Class: io/quarkus/deployment/steps/SmallRyeContextPropagationProcessor$buildStatic62
...
(
    ...
    ** label1
    ...
    INVOKEVIRTUAL io/quarkus/deployment/steps/SmallRyeContextPropagationProcessor$buildStatic62#deploy_0
    RETURN
    ** label2
