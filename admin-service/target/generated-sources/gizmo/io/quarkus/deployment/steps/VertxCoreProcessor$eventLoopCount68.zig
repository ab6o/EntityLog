// Class: io/quarkus/deployment/steps/VertxCoreProcessor$eventLoopCount68
...
(
    ...
    ** label1
    ...
    INVOKEVIRTUAL io/quarkus/deployment/steps/VertxCoreProcessor$eventLoopCount68#deploy_0
    RETURN
    ** label2
