// Class: io/quarkus/deployment/steps/SmallRyeReactiveMessagingProcessor$build82
...
(
    ...
    ** label1
    ...
    INVOKEVIRTUAL io/quarkus/deployment/steps/SmallRyeReactiveMessagingProcessor$build82#deploy_0
    RETURN
    ** label2
