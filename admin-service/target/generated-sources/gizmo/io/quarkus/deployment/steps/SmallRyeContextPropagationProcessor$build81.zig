// Class: io/quarkus/deployment/steps/SmallRyeContextPropagationProcessor$build81
...
(
    ...
    ** label1
    ...
    INVOKEVIRTUAL io/quarkus/deployment/steps/SmallRyeContextPropagationProcessor$build81#deploy_0
    RETURN
    ** label2
