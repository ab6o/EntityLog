// Class: io/quarkus/deployment/steps/ResteasyCommonProcessor$setupResteasyInjection83
...
(
    ...
    ** label1
    ...
    INVOKEVIRTUAL io/quarkus/deployment/steps/ResteasyCommonProcessor$setupResteasyInjection83#deploy_0
    RETURN
    ** label2
