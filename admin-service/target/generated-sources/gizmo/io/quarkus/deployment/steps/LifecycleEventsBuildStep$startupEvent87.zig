// Class: io/quarkus/deployment/steps/LifecycleEventsBuildStep$startupEvent87
...
(
    ...
    ** label1
    ...
    INVOKEVIRTUAL io/quarkus/deployment/steps/LifecycleEventsBuildStep$startupEvent87#deploy_0
    RETURN
    ** label2
