// Class: io/quarkus/deployment/steps/BlockingOperationControlBuildStep$blockingOP75
...
(
    ...
    ** label1
    ...
    INVOKEVIRTUAL io/quarkus/deployment/steps/BlockingOperationControlBuildStep$blockingOP75#deploy_0
    RETURN
    ** label2
