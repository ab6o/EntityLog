// Class: io/quarkus/deployment/steps/ArcProcessor$generateResources78
...
(
    ...
    ** label1
    ...
    ALOAD 9
    CHECKCAST java/util/Collection
    LDC (String) "org.kie.kogito.app.ApplicationProcesses"
    // Method descriptor: (Ljava/lang/Object;)Z
    INVOKEINTERFACE java/util/Collection#add
    POP
    ALOAD 9
    ...
    ALOAD 9
    CHECKCAST java/util/Collection
    LDC (String) "io.smallrye.reactive.messaging.annotations.Emitter"
    // Method descriptor: (Ljava/lang/Object;)Z
    INVOKEINTERFACE java/util/Collection#add
    POP
    ALOAD 9
    ...
    ALOAD 9
    CHECKCAST java/util/Collection
    LDC (String) "org.kie.kogito.process.Processes"
    // Method descriptor: (Ljava/lang/Object;)Z
    INVOKEINTERFACE java/util/Collection#add
    POP
    ALOAD 9
...
(
    ...
    ** label1
    ...
    INVOKEVIRTUAL io/quarkus/deployment/steps/ArcProcessor$generateResources78#deploy_0
    RETURN
    ** label2
