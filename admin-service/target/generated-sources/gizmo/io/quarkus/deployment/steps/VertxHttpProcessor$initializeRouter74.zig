// Class: io/quarkus/deployment/steps/VertxHttpProcessor$initializeRouter74
...
(
    ...
    ** label1
    ...
    INVOKEVIRTUAL io/quarkus/deployment/steps/VertxHttpProcessor$initializeRouter74#deploy_0
    RETURN
    ** label2
