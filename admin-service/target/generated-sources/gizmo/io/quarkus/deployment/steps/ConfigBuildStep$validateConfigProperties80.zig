// Class: io/quarkus/deployment/steps/ConfigBuildStep$validateConfigProperties80
...
(
    ...
    ** label1
    ...
    INVOKEVIRTUAL io/quarkus/deployment/steps/ConfigBuildStep$validateConfigProperties80#deploy_0
    RETURN
    ** label2
