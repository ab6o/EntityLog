// Class: io/quarkus/deployment/steps/KafkaStreamsProcessor$processBuildTimeConfig38
...
(
    ...
    ** label1
    ...
    INVOKEVIRTUAL io/quarkus/deployment/steps/KafkaStreamsProcessor$processBuildTimeConfig38#deploy_0
    RETURN
    ** label2
