// Class: io/quarkus/deployment/steps/BlockingOperationControlBuildStep$blockingOP50
...
(
    ...
    ** label1
    ...
    INVOKEVIRTUAL io/quarkus/deployment/steps/BlockingOperationControlBuildStep$blockingOP50#deploy_0
    RETURN
    ** label2
