// Class: io/quarkus/deployment/steps/KafkaStreamsProcessor$configureAndLoadRocksDb43
...
(
    ...
    ** label1
    ...
    INVOKEVIRTUAL io/quarkus/deployment/steps/KafkaStreamsProcessor$configureAndLoadRocksDb43#deploy_0
    RETURN
    ** label2
