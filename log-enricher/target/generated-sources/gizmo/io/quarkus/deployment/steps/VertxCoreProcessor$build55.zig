// Class: io/quarkus/deployment/steps/VertxCoreProcessor$build55
...
(
    ...
    ** label1
    ...
    INVOKEVIRTUAL io/quarkus/deployment/steps/VertxCoreProcessor$build55#deploy_0
    RETURN
    ** label2
