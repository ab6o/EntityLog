// Class: io/quarkus/deployment/steps/VertxHttpProcessor$initializeRouter49
...
(
    ...
    ** label1
    ...
    INVOKEVIRTUAL io/quarkus/deployment/steps/VertxHttpProcessor$initializeRouter49#deploy_0
    RETURN
    ** label2
