// Class: io/quarkus/deployment/steps/KafkaStreamsProcessor$configureAndLoadRocksDb44
...
(
    ...
    ** label1
    ...
    INVOKEVIRTUAL io/quarkus/deployment/steps/KafkaStreamsProcessor$configureAndLoadRocksDb44#deploy_0
    RETURN
    ** label2
