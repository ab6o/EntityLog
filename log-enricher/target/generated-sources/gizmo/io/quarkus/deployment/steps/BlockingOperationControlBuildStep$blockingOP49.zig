// Class: io/quarkus/deployment/steps/BlockingOperationControlBuildStep$blockingOP49
...
(
    ...
    ** label1
    ...
    INVOKEVIRTUAL io/quarkus/deployment/steps/BlockingOperationControlBuildStep$blockingOP49#deploy_0
    RETURN
    ** label2
