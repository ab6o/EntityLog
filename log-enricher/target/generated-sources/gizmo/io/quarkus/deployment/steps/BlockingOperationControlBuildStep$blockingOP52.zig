// Class: io/quarkus/deployment/steps/BlockingOperationControlBuildStep$blockingOP52
...
(
    ...
    ** label1
    ...
    INVOKEVIRTUAL io/quarkus/deployment/steps/BlockingOperationControlBuildStep$blockingOP52#deploy_0
    RETURN
    ** label2
