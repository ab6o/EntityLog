// Class: io/quarkus/deployment/steps/VertxCoreProcessor$eventLoopCount40
...
(
    ...
    ** label1
    ...
    INVOKEVIRTUAL io/quarkus/deployment/steps/VertxCoreProcessor$eventLoopCount40#deploy_0
    RETURN
    ** label2
