// Class: io/quarkus/deployment/steps/ResteasyCommonProcessor$setupResteasyInjection57
...
(
    ...
    ** label1
    ...
    INVOKEVIRTUAL io/quarkus/deployment/steps/ResteasyCommonProcessor$setupResteasyInjection57#deploy_0
    RETURN
    ** label2
