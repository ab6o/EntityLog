// Class: io/quarkus/deployment/steps/VertxCoreProcessor$eventLoopCount37
...
(
    ...
    ** label1
    ...
    INVOKEVIRTUAL io/quarkus/deployment/steps/VertxCoreProcessor$eventLoopCount37#deploy_0
    RETURN
    ** label2
