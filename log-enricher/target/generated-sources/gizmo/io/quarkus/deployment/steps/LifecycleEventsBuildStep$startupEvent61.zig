// Class: io/quarkus/deployment/steps/LifecycleEventsBuildStep$startupEvent61
...
(
    ...
    ** label1
    ...
    INVOKEVIRTUAL io/quarkus/deployment/steps/LifecycleEventsBuildStep$startupEvent61#deploy_0
    RETURN
    ** label2
