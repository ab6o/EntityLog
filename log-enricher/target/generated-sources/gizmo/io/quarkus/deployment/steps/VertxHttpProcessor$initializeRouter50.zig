// Class: io/quarkus/deployment/steps/VertxHttpProcessor$initializeRouter50
...
(
    ...
    ** label1
    ...
    INVOKEVIRTUAL io/quarkus/deployment/steps/VertxHttpProcessor$initializeRouter50#deploy_0
    RETURN
    ** label2
